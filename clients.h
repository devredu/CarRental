/**
 * @file clients.h
 * @brief Funkcje zarządzające listą klientów.
 * @details Plik zawiera deklaracje funkcji odpowiedzialnych za operacje na liście jednokierunkowej klientów,
 * takich jak dodawanie, usuwanie, edytowanie i wyświetlanie listy klientów.
 */
 ...
 * nadpisania (zmiany) z wyłązeniem numeru karty klienta, który jest indywidualny i nie podlega zmianie.
 * @param lista_klientow Podwójny wskaźnik na początek listy klientów.
 * @return void
 */
